...
# Apply route defaults so Granite (and other defaults) are pulled even when env was created before they were added
HATORI_ROUTE_CLASSIFY_INTENT_MODEL="${HATORI_ROUTE_CLASSIFY_INTENT_MODEL:-granite4:350m}"
HATORI_ROUTE_CLASSIFY_INTENT_FALLBACK_MODEL="${HATORI_ROUTE_CLASSIFY_INTENT_FALLBACK_MODEL:-gemma3:1b}"
HATORI_ROUTE_EXTRACT_FIELDS_MODEL="${HATORI_ROUTE_EXTRACT_FIELDS_MODEL:-granite4:350m}"
HATORI_ROUTE_EXTRACT_FIELDS_FALLBACK_MODEL="${HATORI_ROUTE_EXTRACT_FIELDS_FALLBACK_MODEL:-gemma3:1b}"
...
HATORI_ROUTE_RETRIEVAL_QUERY_BUILD_FALLBACK_MODEL="${HATORI_ROUTE_RETRIEVAL_QUERY_BUILD_FALLBACK_MODEL:-gemma3:1b}"
HATORI_ROUTE_EDIT_PATTERN_CLUSTER_MODEL="${HATORI_ROUTE_EDIT_PATTERN_CLUSTER_MODEL:-granite4:350m}"
HATORI_ROUTE_EDIT_PATTERN_CLUSTER_FALLBACK_MODEL="${HATORI_ROUTE_EDIT_PATTERN_CLUSTER_FALLBACK_MODEL:-gemma3:1b}"
...
HATORI_ROUTE_QUALITY_GATE_MODEL="${HATORI_ROUTE_QUALITY_GATE_MODEL:-llama3.2:3b}"
HATORI_ROUTE_QUALITY_GATE_FALLBACK_MODEL="${HATORI_ROUTE_QUALITY_GATE_FALLBACK_MODEL:-gemma2:2b}"
HATORI_ROUTE_REPLY_WRITE_MODEL="${HATORI_ROUTE_REPLY_WRITE_MODEL:-${HATORI_OLLAMA_MODEL:-llama3.2:3b}}"
HATORI_ROUTE_REPLY_WRITE_FALLBACK_MODEL="${HATORI_ROUTE_REPLY_WRITE_FALLBACK_MODEL:-gemma2:2b}"
HATORI_ROUTE_PLAN_WRITE_MODEL="${HATORI_ROUTE_PLAN_WRITE_MODEL:-${HATORI_OLLAMA_MODEL:-llama3.2:3b}}"
HATORI_ROUTE_PLAN_WRITE_FALLBACK_MODEL="${HATORI_ROUTE_PLAN_WRITE_FALLBACK_MODEL:-gemma2:2b}"
HATORI_ROUTE_REWRITE_POLISH_MODEL="${HATORI_ROUTE_REWRITE_POLISH_MODEL:-${HATORI_OLLAMA_MODEL:-llama3.2:3b}}"
HATORI_ROUTE_REWRITE_POLISH_FALLBACK_MODEL="${HATORI_ROUTE_REWRITE_POLISH_FALLBACK_MODEL:-gemma2:2b}"
...
# Route models (env now has defaults above so granite4:350m is always included when not overridden)
for var in \
