...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v0.7.0-2563EB?style=for-the-badge" alt="Version">
...
- Roadmap: [`docs/11-roadmap/roadmap.md`](docs/11-roadmap/roadmap.md)
- Backlog: [`docs/11-roadmap/backlog.md`](docs/11-roadmap/backlog.md)
- Issue register: [`docs/11-roadmap/issues.md`](docs/11-roadmap/issues.md)
